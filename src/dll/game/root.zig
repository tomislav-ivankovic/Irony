...
pub const ThrowEscapeInput = @import("types.zig").ThrowEscapeInput;
...
pub const AttackInput = @import("types.zig").AttackInput;
pub const DirectionalInput = @import("types.zig").DirectionalInput;
